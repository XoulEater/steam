...
class AdminLogisticController {
    ...
    static async registerAdminLogistic(req, res) {
        try {
    ...
    static async editAdminLogistic(req, res) {
        try {
    ...
    static async registerUsersAdmin(req, res) {
        try {
            const { username, email, password, role } = req.body;
    ...
    static async updateUsersAdmin(req, res) {
        try {
